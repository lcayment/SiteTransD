        ...
        <div class="header-top">
            <?php require_once "header.html" ?>
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 ">
                                <div class="text-bg">
                                    <h1>Recherches</h1>
                                    <span>La persévérance scolaire, Bluebot <br> et une application pour enfants    </span>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="Games">
                            ...
                            <p> Pour mener à bien ce projet, nous avons décidé de continuer d’améliorer les fiches d’observations réalisées par nos camarades de deuxièmes années, ainsi que de réaliser une application permettant de quantifier la persévérance scolaire durant les séances de robotique. Afin de se faire, nous avons axés deux thèmes de recherches : le fond et la forme de l’application. 
                                ...
                                <br> - <u>Ressenti face aux problèmes rencontrés </u>(ex: le robot ne va pas où ils veulent) → Savoir si le fait de rencontrer un problème les frustrent ou leur donnent envie de progresser (utilisation de la montagne).
                                <br> - <u>Engagement/Relationnel </u>(en groupe et en classe entière) → Voir si certains se sentent plus épanouie lorsqu’ils sont en apprentissage individuel ou en apprentissage collectif.
                                <br> - <u>Temporalité </u>(séance entière et différentes phases) → Savoir si certaines phases sont trop courtes ou trop longues pour les enfants pour savoir comment mieux adapter le roulement entre les différentes phases.(Attention à la manière d’appliquer cela puisque le concept de temporalité est en plein développement chez les enfants de cet âge).
                                <br> - <u>Impatience </u>(pour la prochaine séance) → Savoir si la curiosité dépasse juste la séance actuelle ou s' ils ont envie et s'intéressent vraiment au projet
                            </p>
